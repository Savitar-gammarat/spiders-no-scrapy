...
class SinaPipeline(object):
    site_id = sina.site_id
    site_name = sina.site_name
    ...
    def structure_set(self):
        ...
        try:
            ...
            Logger().setLogger(sina.log_path, 2, "Pipelines, Failed to structure set")
            pass
    ...
    def open_spider(self, structure):
        try:
            ...
            Logger().setLogger(sina.log_path, 3, "Failed to open spider(site info may not be inserted")
            pass
    ...
    def process_item(self, item):
        ...
        try:   #尝试对title进行中文分词操作
            ...
            Logger().setLogger(sina.log_path, 2,"Pipelines, Failed to process item,So no jieba or site_id,may cause error,url is")
            item['jieba'] = None
        return item
    ...
    def upload_item(self, item, structure):
        ...
        try:
            ...
            Logger().setLogger(sina.log_path, 2, "Pipelines, Failed to upload item,url is" + item['link'])
            pass
    ...
    def insert_new(self, item, key_list):
        ...
        try:
            ...
            Logger().setLogger(sina.log_path, 4, "Failed to insert new news,url is " + item['link'])
            pass
    ...
    def close_spider(self):
        try:
            ...
            Logger().setLogger(sina.log_path, 4, "Failed to commit or close db_session")